...
function display(view)
{
	if (view == 'grid')
	{
		...
		$('.product_content .item-product').removeClass('col-xs-12').addClass('col-xs-12 col-sm-6 col-md-6 col-lg-3');
	...
	{	
		...
		$('.product_content .item-product').removeClass('col-xs-12 col-sm-6 col-md-6 col-lg-3').addClass('col-xs-12');
		$('.product_content .item-product').each(function(index, element) {
			var html = '';
			var id_product = $(this).children('article.js-product-miniature').attr('data-id-product');
			var id_product_attr = $(this).children('article.js-product-miniature').attr('data-id-product-attribute');
			...
			html += '<div class="img_block col-xs-3 col-sm-3 col-md-3 col-lg-3 ">' + $(element).find('.img_block').html() + '</div>';
			html += '<div class="product_desc col-xs-9 col-sm-9 col-md-9 col-lg-9 ">';	
			html += '<div class="desc-list">';
			html += '<div class="manufacturer">';
				html += '<div class="manufacturer">'+ $(element).find('.manufacturer').html() + '</div>';
			html += '</div>';			
